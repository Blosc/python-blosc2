...
print(
    f"{'Column access to numpy (full)':<30} {t_ct_col:>12.4f} {t_pd_col:>12.4f} {t_pd_col / t_ct_col:>9.3f}x"
)
...
print(
    f"{'Filter (id 250k-750k)':<30} {t_ct_filter:>12.4f} {t_pd_filter:>12.4f} {t_pd_filter / t_ct_filter:>9.2f}x"
)
