...
t = time() - t0
print(
    f"Time to compute where expression (NumExpr): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
...
t = time() - t0
print(
    f"Time to compute where expression (compute): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
...
t = time() - t0
print(
    f"Time to compute where expression (getitem): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
...
t = time() - t0
print(
    f"Time to get row values (compute): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
...
t = time() - t0
print(
    f"Time to get row values (compute, string): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
...
t = time() - t0
print(
    f"Time to get row values (getitem): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
...
t = time() - t0
print(
    f"Time to get row values (getitem, string): {t:.3f} s; {nps.nbytes / 2**30 / t:.3f} GB/s; {tref / t:.1f}x wrt NumPy"
)
